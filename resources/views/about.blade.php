                            ...
                            <div class="inner-box">
                                <div class="image-inner">
                                    ...
                                    <ul class="social-links clearfix">
                                        ...
                                        <li><a href="team.html"><i class="fab fa-pinterest-p"></i></a></li>
                                ...
                                <div class="lower-content">
                                    <h3><a href="index.html">Marry</a></h3>
                                    <span class="designation">Senior cleaner</span>
                                    <div class="link"><a href="index.html"><img src="assets/images/icons/icon-11.png" alt=""></a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="300ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="index.html">Robert Mick</a></h3>
                                    <span class="designation">Cleaning Supervisior</span>
                                    <div class="link"><a href="index.html"><img src="assets/images/icons/icon-11.png" alt=""></a></div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 team-block">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="600ms" data-wow-duration="1500ms">
                            <div class="inner-box">
                                ...
                                <div class="lower-content">
                                    <h3><a href="index.html">Alex Heals</a></h3>
